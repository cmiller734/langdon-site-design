<?php
  if($_POST)
  {
	$to_Email = "amanda@pearlmarketingdesign.com"; //Replace with recipient email address
	...
	$replyHeaders = 'From: amanda@pearlmarketingdesign.com' . "\r\n" .
	'Reply-To: amanda@pearlmarketingdesign.com' . "\r\n" .
	'X-Mailer: PHP/' . phpversion();
	...
	if(!$sentMail)
	{
		...
		mail($user_Email, 'Thank you for contacting me',  'Thank you for contacting me. I have received your message and will reach out to you shortly.' . "\r\n\n" . 'Amanda Schneck' . "\r\n" . 'Pearl Marketing & Design', $replyHeaders);
